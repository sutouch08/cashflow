...
<form class="form-horizontal" id="add_emp_form" method="post" action="<?php echo $this->home."/add"; ?>">
<input type="hidden" name="add" value="1"  />
<button type="button" id="btn_submit" style="display:none">Submit</button>
<input type="hidden" id="valid_fname" />
<input type="hidden" id="valid_lname" />
<div class="row">
<div class="form-group">
<label class="col-lg-4 control-label no-padding-right">ชื่อ </label>
<div class="col-lg-4"><input type="text" name="fname" id="fname" class="form-control" /></div>
<div class="col-lg-4" style="color:red;">*</div>
</div>

<div class="form-group">
<label class="col-lg-4 control-label no-padding-right">นามสกุล </label>
<div class="col-lg-4"><input type="text" name="lname" id="lname" class="form-control" /></div>
<div class="col-lg-4" style="color:red;">*</div>
</div>
<div class="form-group">
...
function save()
{
	...
	if(fname =="" || lname =="" )
	{
		...
		$.ajax({
			url : "<?php echo $this->home."/valid_employee"; ?>"+"/"+fname+"/"+lname,
