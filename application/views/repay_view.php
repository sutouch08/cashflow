...
<?php if( can_do($a['view']) ) : ?>
    	<a href="<?php echo base_url()."repay/view/".$rs->id_bank_ac; ?>" style="text-decoration:none;">
...
<?php if( can_do($a['add']) || can_do($a['edit']) ) : ?>        
        <a href="<?php echo base_url()."repay/add/".$rs->id_bank_ac; ?>" style="text-decoration:none;">
