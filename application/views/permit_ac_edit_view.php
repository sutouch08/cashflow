...
<div class='row'>
	<div class='col-lg-6 col-md-6 col-sm-6'>
    	<h3 style='margin-bottom:0px;'><i class='fa fa-lock'></i>&nbsp; <?php echo $title; ?>&nbsp; : &nbsp; <?php echo $user_name; ?></h3>
    </div>
    <div class='col-lg-6 col-md-6 col-sm-6'>
    	<p class="pull-right">
...
<form id="permit_form" action="<?php echo $this->home; ?>/set_permission/<?php echo $id_user; ?>" method="post">
<input type="hidden" name="edit" value="1" />
<table  id="simple-table"class="table table-striped table-bordered">
<thead>
	<th style="width:30%; text-align:center">เมนู</th>
    <th class="center" style="width:10%;"><label ><input class="ace" type="checkbox" id="view_all" /><span class="lbl">&nbsp;ดู</span></label></th>
...
<?php 	if( ($rs->view + $rs->add + $rs->edit + $rs->delete) == 4){ $all = 1; }else{ $all = 0; } ?>
<tr>
	<td><?php echo bank_ac_detail($rs->id_bank_ac); ?> <input type="hidden" name="id_bank_ac[<?php echo $rs->id_bank_ac; ?>]" value="<?php echo $rs->id_bank_ac; ?>"  /></td>
    <td align="center">
    	<input type="checkbox" class="<?php echo $rs->id_bank_ac; ?> view ace" name="view[<?php echo $rs->id_bank_ac; ?>]" id="view[<?php echo $rs->id_bank_ac; ?>]" value="1" <?php echo isChecked($rs->view, 1); ?> onchange="remove_check_all($(this),<?php echo $rs->id_bank_ac; ?>, 'view_all')"  />
        <span class="lbl"></span>
    </td>
    <td align="center">
    <input type="checkbox" class="<?php echo $rs->id_bank_ac; ?> add ace" name="add[<?php echo $rs->id_bank_ac; ?>]" id="add[<?php echo $rs->id_bank_ac; ?>]" value="1" <?php echo isChecked($rs->add, 1); ?> onchange="remove_check_all($(this),<?php echo $rs->id_bank_ac; ?>, 'add_all')" />
    <span class="lbl"></span>
    </td>
    <td align="center">
    <input type="checkbox" class="<?php echo $rs->id_bank_ac; ?> edit ace" name="edit[<?php echo $rs->id_bank_ac; ?>]" id="edit[<?php echo $rs->id_bank_ac; ?>]" value="1" <?php echo isChecked($rs->edit, 1); ?> onchange="remove_check_all($(this),<?php echo $rs->id_bank_ac; ?>, 'edit_all')" />
    <span class="lbl"></span>
    </td>
    <td align="center">
    <input type="checkbox" class="<?php echo $rs->id_bank_ac; ?> delete ace" name="delete[<?php echo $rs->id_bank_ac; ?>]" id="delete[<?php echo $rs->id_bank_ac; ?>]" value="1" <?php echo isChecked($rs->delete, 1); ?> onchange="remove_check_all($(this),<?php echo $rs->id_bank_ac; ?>, 'delete_all')" />
    <span class="lbl"></span>
    </td>
    <td align="center"><input type="checkbox" class="all<?php echo $rs->id_bank_ac; ?> ace" id="all_<?php echo $rs->id_bank_ac; ?>" onchange="select_all($(this), <?php echo $rs->id_bank_ac; ?>)"  <?php echo isChecked($all, 1); ?> /><span class="lbl"></span></td>
</tr>
<?php 	endforeach; ?>
