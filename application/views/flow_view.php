...
<div class="col-lg-2 col-md-3 col-sm-6">
	...
	<input type="text" id="detail" name="detail" placeholder="ระบุรายการค้นหา" class="form-control" />
</div>
<div class="col-lg-2 col-md-3 col-sm-6">
	<label for="reference">เลขที่เอกสาร</label>
	<input type="text" id="reference" name="reference" placeholder="ระบุเลขที่เอกสาร" class="form-control" />
</div>
<div class="col-lg-2 col-md-3 col-sm-6">
	<label for="from_date">จากวันที่</label>
	<input type="text" id="from_date" name="from_date" placeholder="กำหนดวันที่เริ่มต้น" class="form-control" />
</div>
<div class="col-lg-2 col-md-3 col-sm-6">
	<label for="to_date">ถึงวันที่</label>
	<input type="text" id="to_date" name="to_date" placeholder="กำหนดวันที่สิ้นสุด" class="form-control" />
</div>
<div class="col-lg-2 col-md-3 col-sm-6">
	<label for="btn_search" style="display:block;">&nbsp;</label>
	<button class="btn btn-info btn-sm" id="btn_search" onclick="get_search()" ><i class="fa fa-search"></i>&nbsp; ค้นหา</button>
</div>
</form>
</div>
