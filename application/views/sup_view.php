...
<thead>
    ...
    <th style="width:35%;">ชื่อผู้ขาย</th>
    <th style="width:15%; text-align:center">ปรับปรุงล่าสุด</th>
...
<tr>
    ...
    <td class="align-middle" align="center"><?php echo thaiDate($rs->date_upd, "", true); ?></td>
...
<tr>
	<td colspan="6" align="center">
    	<div class="alert alert-info">
			...
			<strong><i class="ace-icon fa fa-exclamation-circle"></i>&nbsp; ยังไม่มีรายชื่อผู้ขาย</strong><br>
		</div>
    </td>
</tr>
