...
<div class="col-lg-4">
	<input type="text" name="ac_code" id="ac_code" class="form-control" placeholder="กำหนดรหัสบัญชี เพื่อให้ง่ายต่อการจดจำ" required autocomplete="off" />
</div>
...
<div class="col-lg-4"><input type="text" name="ac_number" id="ac_number" class="form-control" placeholder="ระบุเลขที่บัญชี (รูปแบบเดียวกับที่ปรากฎบนหน้าสมุดบัญชี)" required autocomplete="off" /></div>
<div class="col-lg-4" style="color:red;">*</div>
</div>

<div class="form-group">
<label class="col-lg-4 control-label no-padding-right">ชื่อบัญชี</label>
<div class="col-lg-4"><input type="text" name="ac_name" id="ac_name" class="form-control" placeholder="ระบุชื่อบัญชี" required  /></div>
<div class="col-lg-4" style="color:red;">*</div>
</div>

<div class="form-group">
<label class="col-lg-4 control-label no-padding-right">สาขา</label>
<div class="col-lg-4"><input type="text" name="branch" id="branch" class="form-control" placeholder="ระบุสาขาธนาคาร" /></div>
<div class="col-lg-4" style="color:red;"></div>
</div>

<div class="form-group">
<label class="col-lg-4 control-label no-padding-right">ประเภทบัญชี</label>
<div class="col-lg-4"><input type="text" name="ac_type" id="ac_type" class="form-control" placeholder="ระบุประเภทบัญชี" /></div>
<div class="col-lg-4" style="color:red;"></div>
</div>
...
<div class="col-lg-4"><input type="text" name="od_budget" id="od_budget" class="form-control" placeholder="กำหนดวงเงิน OD (ตัวเลขเท่านั้น)" autocomplete="off" /></div>
<div class="col-lg-4" style="color:red;"></div>
</div>
...
<div class="col-lg-4">
	...
	<input type="text" name="od_rate" id="od_rate" class="form-control" placeholder="ระบุอัตราดอกเบี้ย OD เป็นตัวเลข เช่น 5 หรือ 3.2 เป็นต้น" autocomplete="off" />
...
<div class="col-lg-4">
	<input type="text" name="loan_budget" id="loan_budget" class="form-control" placeholder="กำหนดวงเงินสำหรับกู้ตั๋วของบัญชีนี้" autocomplete="off" />
</div>
<div class="col-lg-4" style="color:#666;"></div>
</div>
...
<div class="col-lg-4">
	<div class="control-group">
    	<div class="radio"><label><input name="int" id="pay_method1" class="ace" type="radio" value="1" ><span class="lbl"> จ่ายทันที</span></label></div>
    	<div class="radio"><label><input name="int" id="pay_method2" class="ace" type="radio" value="0" checked ><span class="lbl"> จ่ายเมื่อครบกำหนด</span></label></div>
    	<div class="radio"><label><input name="int" id="pay_method3" class="ace" type="radio" value="2" ><span class="lbl"> จ่ายทุกวันที่กำหนด</span></label></div>
        <div class="control-group" id="pay_option" style="padding-left:30px; display:none">
        	<div class="radio"><label><input name="pay_in_date" id="pay_in_last" class="ace" type="radio" value="x" ><span class="lbl"> จ่ายทุกสิ้นเดือน</span></label></div>
            <div class="radio">
            	<label>
                <input name="pay_in_date" id="pay_in_date" class="ace" type="radio" value="1" >
                <span class="lbl"> จ่ายทุกวันที่</span>
                <input type="text" name="pay_date" id="pay_date" placeholder="1 - 31" style="margin-left:10px; margin-right:10px; width:50px;" />
...
<div class="col-lg-4">
	<div class="control-group">
    	<div class="radio"><label><input name="int_cal" id="cal_all" class="ace" type="radio" value="1" ><span class="lbl"> ใช้เงินต้นทั้งหมดมาคำนวณดอกเบี้ย</span></label></div>
    	<div class="radio"><label><input name="int_cal" id="cal_bal" class="ace" type="radio" value="0" checked ><span class="lbl"> ใช้ยอดค้างชำระมาคำนวณดอกเบี้ย</span></label></div>
    </div>
</div>
<div class="col-lg-4" style="color:#666;"></div>
</div>
...
<div class="col-lg-4">
	<label><select name="in_book" id="in_book" class="form-control"><?php echo book_select(); ?></select></label>
</div>
<div class="col-lg-4" style="color:#666;"></div>
</div>
...
function save()
{
	...
	if(ac_code == "")
	{
		...
		$.ajax({
			url : "<?php echo $this->home."/valid_ac_code"; ?>"+"/"+ac_code,
			type: "GET", cache:false, success: function(rs){
				if(rs == 1){
					...
					$.ajax({
						url : "<?php echo $this->home."/valid_ac_number"; ?>"+"/"+ac_no+"/"+id_bank,
