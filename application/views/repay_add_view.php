...
<div class="col-lg-2 col-md-4 col-sm-6">
    ...
    <input type="text" id="reference" name="reference" class="form-control" placeholder="เลือกเลขที่เอกสารเพื่อชำระคืน"  />
</div>
<div class="col-lg-2 col-md-4 col-sm-6">
	<label for="amount">จำนวนเงิน</label>
	<input type="text" id="amount" name="amount" placeholder="จำนวนเงินจ่ายคืน" class="form-control" style="text-align: center" />
</div>
...
<?php 		$id		= $rs->id_repay; ?>
	<tr id="<?php echo $id; ?>" style="background-color: <?php echo $rs->color; ?>">
    	<td align="center">
		<?php if(can_do($a['add']) || can_do($p['edit']) )  : ?>
