...
<div class="col-lg-2 col-md-4 col-sm-6">
    <label for="date_add">วันที่เพิ่ม</label>
    <div class="input-group">
	<input type="text" id="date_add" name="date_add" class="form-control" placeholder="วันที่เอกสาร" style="text-align: center" autofocus="autofocus" />
    <span class="input-group-btn" id="icon_calendar"><button type="button" class="btn btn-default btn-sm" onclick="get_balance()" ><i class="fa fa-calendar"></i>&nbsp; Check!</button></span>
    </div>
</div>

<div class="col-lg-2 col-md-4 col-sm-6">
	<label for="detail">รายการ</label>
	<input type="text" id="detail" name="detail" placeholder="ระบุรายละเอียด" class="form-control" />
</div>

<div class="col-lg-2 col-md-4 col-sm-6">
	<label for="reference">เลขที่เอกสาร</label>
	<input type="text" id="reference" name="reference" placeholder="ระบุเลขที่เอกสาร PN/LC" class="form-control" style="text-align: center" />
</div>
<div class="col-lg-2 col-md-4 col-sm-6">
	<label for="amount">จำนวนเงิน</label>
	<input type="text" id="amount" name="amount" placeholder="จำนวนเงินที่กู้" class="form-control" style="text-align: center" />
</div>

<div class="col-lg-2 col-md-2 col-sm-6">
	<label for="rate">ดอกเบี้ย</label>
    <div class="input-group">
	<input type="text" id="rate" name="rate" placeholder="อัตราดอกเบี้ย" class="form-control" style="text-align: center" />
    <span class="input-group-addon">%</span>
    </div>
</div>
<div class="col-lg-2 col-md-4 col-sm-6">
	<label for="days">ระยะเวลา</label>
    <div class="input-group">
	<input type="text" id="days" name="days" placeholder="ระยะเวลาชำระคืน" class="form-control" style="text-align: center" />
...
<div class="col-lg-2 col-md-3 col-sm-6" style="visibility:hidden">
	<label for="xxx" style="display:block;">&nbsp;</label>
	<button type="button" class="btn btn-warning btn-sm" ><i class="fa fa-refresh"></i>&nbsp; เคลีร์ยตัวกรอง</button>
</div>
</form>
</div>
</div>
...
$("#date_add").keyup(function(e) { if(e.keyCode == 107){ $(this).trigger("addKey"); } });
