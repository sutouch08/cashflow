...
<div class="col-lg-4"><input type="text" name="profile_name" id="profile_name" class="form-control" required="required" autocomplete="off" /></div>
...
function save()
{
	...
	if(profile_name == "")
	{
		...
		$.ajax({
			url : "<?php echo $this->home; ?>/valid_name/"+profile_name,
